...
2. P0.1已确认forced-opaque策略。逐episode恢复MJCF/state后，在临时forced-opaque上下文直接生成`[T,3,256,320] float16` normalized PointMap `.npy`；原始RGB不改。sidecar、源摘要、数组摘要、原子发布和最终manifest/audit共同支持中断恢复。
